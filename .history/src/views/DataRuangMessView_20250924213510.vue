<template>
  <div>
       ...
       <transition name="modal">
            <div v-if="showAddGuesthouseModal" class="detail-modal fixed inset-0 bg-gray-900 bg-opacity-50 flex items-center justify-center z-[80]">
                ...
                <h2 class="text-2xl text-black font-bold data-gedung-text mb-6 text-center">Tambah Gedung Mess</h2>
                    ...
                    <transition name="modal">
                        <div v-if="showAddRoomSlideshow" class="photo-slideshow fixed inset-0 flex items-center justify-center z-[70]">
                            <!-- Overlay hitam sebagai background -->
                            <div class="absolute inset-0 bg-black bg-opacity-75"></div>
        ...
        <transition name="modal">
            <div v-if="showEditRoomSlideshow" class="photo-slideshow fixed inset-0 flex items-center justify-center z-[90]">
            <!-- Overlay hitam sebagai background -->
            <div class="absolute inset-0 bg-black bg-opacity-75"></div>
      ...
      <transition name="modal">
          <div v-if="showCancelConfirmModal" class="fixed inset-0 bg-gray-900 bg-opacity-75 flex items-center justify-center z-[100]">
