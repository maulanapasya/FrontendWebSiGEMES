      ...
      <div v-if="showFilterModal" class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4" @click="closeFilterModal">
        <div class="bg-blue-100 rounded-lg max-w-lg w-full p-6" @click.stop>
          ...
          <div class="mb-4">
            ...
            <div class="relative">
              <div class="flex items-center gap-2 bg-white border border-gray-300 rounded-lg px-2 py-2.5 cursor-pointer hover:border-blue-400 transition-colors"
                  @click="togglePaymentStatusDropdown">
                <span class="text-gray-600 text-sm flex-1">{{ getPaymentStatusLabel() }}</span>
                <svg class="w-4 h-4 text-gray-500 transition-transform" :class="{ 'rotate-180': showPaymentStatusDropdown }" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"/>
                </svg>
              </div>
          ...
          <div class="mb-4">
            ...
            <div class="relative">
              <div class="flex items-center gap-2 bg-white border border-gray-300 rounded-lg px-3 py-2.5 cursor-pointer hover:border-blue-400 transition-colors"
                ...
                <span class="text-black text-sm font-medium">Jenis</span>
            ...
            <div class="mb-4">
              ...
              <div class="relative">
                <div class="flex items-center gap-2 bg-white border border-gray-300 rounded-lg px-3 py-2.5 cursor-pointer hover:border-blue-400 transition-colors"
                  ...
                  <span class="text-black text-sm font-medium">Tipe</span>
            ...
            <div class="mb-4">
              ...
              <div class="relative">
                <div class="flex items-center gap-2 bg-white border border-gray-300 rounded-lg px-3 py-2.5 cursor-pointer hover:border-blue-400 transition-colors"
                  ...
                  <span class="text-black text-sm font-medium">Retribusi</span>
          ...
          <div v-if="!filterRentalType" class="mb-4">
            ...
            <div class="flex items-center gap-2 bg-gray-100 border border-gray-200 rounded-lg px-3 py-2.5 cursor-not-allowed">
