        ...
        <div class="bg-blue-100 rounded-lg max-w-lg w-1/4 max-h-[90vh] overflow-hidden" @click.stop>
          ...
          <div class="relative z-50 px-6 pb-6 max-h-[calc(90vh-120px)] overflow-y-auto">
            ...
            <div class="mb-4">
              ...
              <!-- Setelah checkbox "Semua Tanggal", tambahkan ini: -->
              ...
              <div class="space-y-2">
                ...
                <label v-for="option in paymentStatusOptionsForCheckbox" 
                  ...
                  <input 
                    ...
                    class="mr-2"
                  />
                  <span class="text-black text-sm" :class="{ 'text-gray-400': filterAllPaymentStatuses }">{{ option.label }}</span>
                </label>

                <div v-if="filterAllPaymentStatuses" class="mb-3 p-3 bg-yellow-50 border border-yellow-200 rounded-lg">
                  <p class="text-sm text-yellow-800 font-medium">
