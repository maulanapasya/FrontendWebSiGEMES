                              ...
                              <div>
                                  ...
                                  <div class="flex flex-wrap gap-2 mb-2">
                                      <span 
                                          ...
                                          :key="index" 
                                          class="bg-blue text-black px-3 py-1 rounded-full text-sm flex items-center"
                                      >
                                          {{ facility }}
                                          <button @click="removeFacility(index)" class="ml-2 text-gray-500 hover:text-gray-700">
                                              ×
                                          </button>
                                      </span>
                                  </div>
