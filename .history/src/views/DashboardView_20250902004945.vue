        ...
        <div class="flex items-center justify-between gap-4 mb-6">
          ...
          <div class="flex-1 max-w-md">
            <div class="relative">
              ...
              <input 
                ...
                class="w-full pl-10 pr-4 py-2 border border-gray-300 rounded-lg text-black placeholder-gray-500 focus:outline-none focus:border-blue-500"
              />
            </div>
          </div>
          ...
          <div class="flex items-center gap-4">
            ...
            <div class="flex items-center gap-2">
              ...
              <span class="text-black font-medium">Urutkan</span>
              <select 
                v-model="sortBy"
                @change="handleSortChange"
                class="border border-gray-300 rounded-lg px-3 py-2 text-black min-w-40">
                <option value="newest">Terbaru</option>
                <option value="oldest">Terlama</option>
                <option value="name">Nama Penyewa Urut Abjad</option>
              </select>
            </div>
            ...
            <div class="flex items-center gap-2">
              ...
              <select 
                ...
                class="border border-gray-300 rounded-lg px-3 py-2 text-black min-w-16">
            ...
            <button 
              ...
              class="flex items-center gap-2 bg-blue-500 text-white px-4 py-2 rounded-lg hover:bg-blue-700 font-medium">
      ...
      <div v-if="showFilterModal" class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4" @click="closeFilterModal">
        <div class="bg-blue-100 rounded-lg max-w-lg w-full p-6" @click.stop>
          ...
          <div class="mb-4">
            ...
            <!-- Date Range Picker - Option 1: Vue Datepicker -->
            <div v-if="!filterAllDates && useVueDatepicker" class="mb-3">
              <VueDatePicker
                v-model="dateRange"
                range
            ...
            <!-- Date Range Inputs - Fallback/Alternative -->
          ...
          <div class="mb-4">
            ...
            <select v-model="filterPaymentStatus" class="w-full p-3 border border-gray-300 rounded-lg text-black">
          ...
          <div class="mb-4">
            ...
            <select v-model="filterRentalType" @change="handleRentalTypeChange" class="w-full p-3 border border-gray-300 rounded-lg text-black">
              <option value="">Semua</option>
              <option value="guesthouse">Gedung Mess</option>
              <option value="city_hall">Gedung Nasional</option>
            </select>
          </div>
          ...
          <template v-if="filterRentalType === 'guesthouse'">
            ...
            <div class="mb-4">
              ...
              <select v-model="filterRoomType" class="w-full p-3 border border-gray-300 rounded-lg text-black">
                <option value="">Semua</option>
            ...
            <div class="mb-4">
              ...
              <select v-model="filterRetribution" class="w-full p-3 border border-gray-300 rounded-lg text-black">
                <option value="">Semua</option>
                <option value="Pejabat Negara / Pejabat Pemerintah">Pejabat Negara / Pejabat Pemerintah</option>
                <option value="PNS (Gol. II, III, dan IV)">PNS (Gol. II, III, dan IV)</option>
                <option value="Umum">Umum</option>
                <option value="Khusus Booking 1 Kamar">Khusus Booking 1 Kamar</option>
              </select>
            </div>
          </template>
          ...
          <template v-if="filterRentalType === 'city_hall'">
            <div class="mb-4">
              ...
              <select v-model="filterActivityType" class="w-full p-3 border border-gray-300 rounded-lg text-black">
                <option value="">Semua</option>
          ...
          <div v-if="!filterRentalType" class="mb-4">
            ...
            <select disabled class="w-full p-3 border border-gray-200 rounded-lg text-gray-400 bg-gray-100 cursor-not-allowed">
              <option>-</option>
            </select>
          </div>
...
export default {
  ...
  data() {
    return {
      ...
      // Date picker options
      // useVueDatepicker: false, // COMMENTED OUT - Only using Vue Datepicker now
  ...
  methods: {
    ...
    // COMMENTED OUT - Toggle functionality removed
    /*
    ...
    */
    ...
    // COMMENTED OUT - Legacy method no longer needed
    /*
    openCalendarPicker() {
