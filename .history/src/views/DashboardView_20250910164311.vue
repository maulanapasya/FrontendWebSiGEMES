  ...
  methods: {
    ...
    async exportToExcel() {
      ...
      try {
        ...
        const summaryData = await this.prepareSummaryData(this.selectedCityHalls, this.selectedGuesthouses, startDateStr, endDateStr);
    ...
    async prepareSummaryData(cityHalls, guesthouses, startDateStr, endDateStr) {
      const summary = [];
      let totalRenters = 0;
      let totalRevenue = 0;
