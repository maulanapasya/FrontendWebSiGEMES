                ...
                <template v-if="rentalDetail.guesthouse_room_pricing">
                  ...
                  <div class="flex" v-if="getRoomType(rentalDetail)">
                    ...
                    <span class="font-medium text-black flex-1 text-sm flex items-center">
                      <!-- VIP Type -->
                      <template v-if="getRoomType(rentalDetail).toLowerCase() === 'vip'">
                        <img src="@/assets/vipclass.png" alt="VIP" class="h-5 w-5 mr-2" />
                        <span>VIP</span>
                      </template>
                      <!-- Standard Type -->
                      <template v-else-if="getRoomType(rentalDetail).toLowerCase() === 'standard'">
                        <img src="@/assets/standardclass.png" alt="Standard" class="h-5 w-5 mr-2" />
                        <span>Standard</span>
                      </template>
                      <!-- Other Types -->
                      <template v-else>
