          ...
          <div class="mb-6">
            ...
            <div class="relative">
              ...
              <div 
                ...
                class="flex items-center justify-between p-3 border border-gray-300 rounded-lg bg-white cursor-pointer"
              >
              ...
              <div 
                ...
                v-click-outside="closeMonthPicker"
              >
                <!-- Year Navigation -->
                <div class="flex justify-between items-center border-b border-gray-200 p-3">
                  ...
                  <span class="text-black font-medium">{{ pickerYear }}</span>
                  <button 
                    @click="changeYear(1)" 
                    class="p-1 rounded-full hover:bg-gray-100"
                    :disabled="isMaxYear"
                  >
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" :class="isMaxYear ? 'text-gray-300' : 'text-gray-700'" viewBox="0 0 20 20" fill="currentColor">
                ...
                <div class="grid grid-cols-3 gap-2 p-3">
                  <button 
                    ...
                    :class="[
                      'py-2 px-1 rounded-md text-sm font-medium',
                      getSelectedMonth() === index + 1 && pickerYear === getSelectedYear() 
