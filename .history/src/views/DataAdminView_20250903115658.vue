<template>
    <div>
        ...
        <div class="container mt-6 mx-auto px-6 py-8">
            ...
            <!-- Tabel Data Admin -->
            <div class="mt-4 bg-blue-50 p-6 rounded-xl shadow-xl overflow-auto">
                <table class="w-full border-collapse">
                    <thead>
                        <tr class="data-admin-text bg-blue-500 text-black">
        ...
        <transition name="modal-fade">
            <div v-if="showEditModal" class="fixed inset-0 bg-gray-900 bg-opacity-50 flex items-center justify-center">
                <div class="modal bg-blue-100 w-3/4 max-w-lg rounded-lg shadow-lg p-6 relative">
