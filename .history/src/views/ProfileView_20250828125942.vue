  ...
  <div>
    ...
    <div class="container mx-auto px-4 py-8">
      ...
      <div v-if="isLoadingProfile" class="flex justify-center">
        <div class="bg-blue-100 p-8 rounded-xl shadow-lg animate-pulse" style="min-width: 500px; max-width: 700px;">
          <div class="flex gap-8">
            <!-- Skeleton Profile Picture Section -->
            <div class="flex flex-col items-center">
              <div class="w-32 h-32 bg-gray-300 rounded-full"></div>
              <div class="mt-4 h-4 w-24 bg-gray-300 rounded"></div>
            </div>
            ...
            <div class="flex-1">
              <!-- Skeleton Nama -->
              <div class="mb-4">
                <div class="h-5 w-16 bg-gray-400 rounded mb-2"></div>
              ...
              <div class="mb-4">
                <div class="h-5 w-16 bg-gray-400 rounded mb-2"></div>
                <div class="h-6 w-56 bg-gray-300 rounded"></div>
              </div>

              <!-- Skeleton Phone -->
              <div class="mb-6">
                <div class="h-5 w-24 bg-gray-400 rounded mb-2"></div>
          ...
          <div class="flex gap-8">
            ...
            <div class="flex flex-col items-center">
              ...
              <button 
                ...
                class="text-blue-500 hover:text-blue-700 mt-4 font-medium underline text-sm">
                Ganti foto profil
              </button>
            </div>
            ...
            <div class="flex-1">
              ...
              <div class="flex flex-col items-start gap-3">
                ...
                <button 
                  ...
                  class="text-blue-500 hover:text-blue-700 font-medium underline text-sm">
                  Ganti password
                </button>
              </div>
            </div>
