          ...
          <table class="w-full border-collapse border border-gray-300">
            <thead>
              <tr class="bg-blue-500 text-black">
                <th class="rent-column py-3 px-4 border text-white border-gray-300 text-center font-bold w-16">No</th>
                <th class="rent-column py-3 px-4 border text-white border-gray-300 text-center font-bold w-32">Penyewa</th>
                <th class="rent-column py-3 px-4 border text-white border-gray-300 text-center font-bold w-40">Jenis Sewa</th>
                <th class="rent-column py-3 px-4 border text-white border-gray-300 text-center font-bold w-48">Mulai Sewa</th>
                <th class="rent-column py-3 px-4 border text-white border-gray-300 text-center font-bold w-48">Selesai Sewa</th>
                <th class="rent-column py-3 px-4 border text-white border-gray-300 text-center font-bold w-24">Aksi</th>
              </tr>
            </thead>
            <tbody>
              ...
              <template v-else>
                <tr v-for="(rental, index) in rentals" :key="rental.id" class="bg-white rent-column font-medium text-black border-b border-gray-200">
