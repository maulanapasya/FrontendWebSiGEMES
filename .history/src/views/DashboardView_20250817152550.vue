    ...
    <div class="container mt-6 mx-auto px-6 py-8">
      ...
      <div class="flex flex-wrap gap-4 mt-6">
        <div class="bg-blue-100 p-6 rounded-xl shadow-lg flex-1">
          <p class="text-gray-800">Pendapatan Rabu, 19 Februari 2025</p>
          <h2 class="revenue text-3xl text-black font-bold">Rp1.450.000</h2>
        </div>
        <div class="bg-blue-100 p-6 rounded-xl shadow-lg flex-1">
          <p class="text-gray-800">Pendapatan bulan Februari 2025</p>
          <h2 class="revenue text-3xl text-black font-bold">Rp14.450.000</h2>
        </div>
        <div class="bg-blue-100 p-6 rounded-xl shadow-lg flex-1">
          <p class="text-gray-800">Total pendapatan tahun 2025</p>
          <h2 class="revenue text-3xl text-black font-bold">Rp50.000.000</h2>
        </div>
      </div>
