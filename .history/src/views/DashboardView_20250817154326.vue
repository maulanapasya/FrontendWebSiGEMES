    ...
    <div class="container mt-6 mx-auto px-6 py-8">
      ...
      <div class="flex flex-wrap gap-4 mt-6">
        <div class="bg-blue-100 p-6 rounded-xl shadow-lg flex-1">
          <p class="text-gray-800">Pendapatan {{ currentDayText }}</p>
          <h2 class="revenue text-3xl text-black font-bold">{{ loadingRevenue ? 'Memuat...' : formatCurrency(dailyRevenue) }}</h2>
        </div>
        <div class="bg-blue-100 p-6 rounded-xl shadow-lg flex-1">
          <p class="text-gray-800">Pendapatan bulan {{ currentMonthText }}</p>
          <h2 class="revenue text-3xl text-black font-bold">{{ loadingRevenue ? 'Memuat...' : formatCurrency(monthlyRevenue) }}</h2>
        </div>
        <div class="bg-blue-100 p-6 rounded-xl shadow-lg flex-1">
          <p class="text-gray-800">Total pendapatan tahun {{ currentYear }}</p>
          <h2 class="revenue text-3xl text-black font-bold">{{ loadingRevenue ? 'Memuat...' : formatCurrency(annualRevenue) }}</h2>
        </div>
      </div>
