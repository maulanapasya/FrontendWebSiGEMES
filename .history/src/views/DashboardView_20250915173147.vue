...
export default {
  ...
  methods: {
    ...
    async createSummaryReport(allBuildingData, monthName, year) {
      ...
      worksheet.columns = [
        { width: 8 }, { width: 45 }, { width: 18 }, { width: 25 }
      ];

      // PERBAIKAN: Set row heights yang lebih tinggi untuk kop surat
      ...
      titles.forEach((title, index) => {
        const row = 8 + index;
        worksheet.getRow(row).height = 20; // PERBAIKAN: Tinggi baris lebih besar
      ...
      worksheet.getRow(headerRow).height = 18; // PERBAIKAN: Tinggi header lebih besar
      ...
      allBuildingData.forEach((building, index) => {
        ...
        worksheet.getRow(currentRow).height = 16; // PERBAIKAN: Tinggi baris data
      ...
      worksheet.getRow(totalRow).height = 18; // PERBAIKAN: Tinggi baris total
      ...
      const currentDate = `${dayName}, ${day} ${currentMonthName} ${yearName}`;
