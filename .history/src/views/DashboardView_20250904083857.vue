        ...
        <div class="bg-blue-100 rounded-lg max-w-lg w-1/4 max-h-[90vh] overflow-hidden" @click.stop>
          ...
          <div class="relative z-50 px-6 pb-6 max-h-[calc(90vh-120px)] overflow-y-auto">
            ...
            <div class="mb-4">
              ...
              <div v-if="dateRangeError" class="mb-3">
                <p class="text-red-500 text-sm font-medium">{{ dateRangeError }}</p>
              </div>
            </div>
...
export default {
  ...
  methods: {
    ...
    // TEST METHOD - Remove this after debugging
    testValidation() {
      console.log('=== TEST VALIDATION ===');
      console.log('Current state:');
      console.log('- filterAllDates:', this.filterAllDates);
      console.log('- filterStartDate:', this.filterStartDate);
      console.log('- filterEndDate:', this.filterEndDate);
      console.log('- dateRange:', this.dateRange);
      console.log('- dateRangeError:', this.dateRangeError);
      
      // Force set error for testing
      this.dateRangeError = 'TEST ERROR - This should be visible';
      console.log('Set dateRangeError to test value');
      
      // Test in 3 seconds, remove it
      setTimeout(() => {
        this.dateRangeError = '';
    ...
    async fetchRentals() {
      ...
      try {
        ...
        if (response.data.status) {
          ...
          // Client-side filtering since API doesn't support all filter parameters
