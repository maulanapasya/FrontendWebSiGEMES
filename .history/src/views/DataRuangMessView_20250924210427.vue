  ...
  <div>
      ...
      <div class="container mt-6 mx-auto px-6 py-8">
       ...
       <transition name="modal">
        ...
        <transition name="modal">
            <div v-if="showEditGuesthouseSlideshow" class="photo-slideshow fixed inset-0 flex items-center justify-center z-1000">
                <!-- Overlay hitam sebagai background -->
                <div class="absolute inset-0 bg-black bg-opacity-75"></div>
      ...
      <transition name="modal">
          <div v-if="showCancelConfirmModal" class="fixed inset-0 bg-gray-900 bg-opacity-75 flex items-center justify-center z-[9999]">
