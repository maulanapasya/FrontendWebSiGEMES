<template>
  ...
  <div v-if="showFilterModal" class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-2 sm:p-4" @click="closeFilterModal">
    <!-- 
    Perubahan utama:
    1. Tambahkan responsive width: w-full sm:w-auto sm:max-w-lg
    2. Tambahkan responsive max-height untuk berbagai ukuran layar
    3. Padding responsif: p-2 sm:p-4
    4. Adjust content area height untuk mobile
    -->
    <div class="bg-blue-100 rounded-lg w-full sm:w-auto sm:max-w-lg max-h-[95vh] sm:max-h-[90vh] overflow-hidden flex flex-col" @click.stop>
      
      <!-- Header - Fixed height -->
      <div class="flex-shrink-0">
        <h2 class="rent-column text-xl sm:text-2xl font-bold text-black text-center mb-4 sm:mb-6 p-4 sm:p-6 pb-0">Filter Berdasarkan</h2>
      </div>
      ...
      <div class="flex-1 overflow-y-auto px-4 sm:px-6 pb-4 sm:pb-6">
        <!-- Date Range -->
        <div class="mb-4">
          <h3 class="rent-column font-bold text-black mb-3 text-sm sm:text-base">Rentang Tanggal</h3>
          ...
          <div class="mb-3">
            <label class="flex items-center cursor-pointer">
              <input 
                ...
                class="mr-2"
              />
              <span class="text-black rent-column font-medium text-sm sm:text-base">Semua Tanggal</span>
            </label>
          </div>
          ...
          <!-- Petunjuk -->
          <div v-if="filterAllDates" class="mb-3 p-2 sm:p-3 bg-yellow-50 border border-yellow-200 rounded-lg">
            <p class="text-xs sm:text-sm rent-column text-yellow-800 font-medium">
          ...
          <div v-if="dateRangeValidationError" class="mb-3">
            <p class="text-red-500 rent-column text-xs sm:text-sm font-bold">{{ dateRangeValidationError }}</p>
          </div>
        </div>

        <!-- Jenis Sewa -->
        <div class="mb-4">
          <h3 class="rent-column font-bold text-black mb-3 text-sm sm:text-base">Jenis Sewa</h3>
          <div class="relative">
            <div class="flex items-center gap-2 bg-white border border-gray-300 rounded-lg px-3 py-2.5 cursor-pointer hover:border-blue-400 transition-colors"
              ...
              <span class="text-gray-600 text-xs sm:text-sm flex-1">{{ getRentalTypeLabel() }}</span>
            ...
            <div v-if="showRentalTypeDropdown" 
              ...
              <div class="py-1">
                <div v-for="option in rentalTypeOptions" 
                    ...
                    class="px-3 py-2 text-xs sm:text-sm text-black hover:bg-blue-50 cursor-pointer"
        ...
        <!-- Payment Status -->
        <div class="mb-4">
          <h3 class="rent-column font-bold text-black mb-3 text-sm sm:text-base">Status Pembayaran</h3>
          <div class="space-y-2">
            <!-- Semua Checkbox -->
            <label class="flex items-center rent-column cursor-pointer hover:bg-gray-50 p-2 rounded">
              <input 
                ...
                class="mr-2"
              />
              <span class="text-black text-xs sm:text-sm font-medium">Semua</span>
            </label>
            ...
            <label v-for="option in paymentStatusOptionsForCheckbox" 
              ...
              <input 
                ...
                class="mr-2"
              />
              <span class="text-black rent-column text-xs sm:text-sm" :class="{ 'text-gray-400': filterAllPaymentStatuses }">{{ option.label }}</span>
            </label>

            <!-- Petunjuk untuk Payment Status -->
            <div v-if="filterAllPaymentStatuses" class="mb-2 p-2 sm:p-2 bg-yellow-50 border border-yellow-200 rounded-lg">
              <p class="text-xs sm:text-sm rent-column text-yellow-800 font-medium">
      ...
      <div class="flex-shrink-0 flex justify-center gap-3 sm:gap-4 p-4 sm:p-6 pt-2 sm:pt-0 border-t border-gray-200">
        <button 
          @click="applyFilters"
          class="rent-column bg-blue-500 text-white px-4 sm:px-6 py-2 sm:py-3 rounded-lg font-semibold hover:bg-blue-700 text-sm sm:text-base">
          Simpan
        </button>
        <button 
