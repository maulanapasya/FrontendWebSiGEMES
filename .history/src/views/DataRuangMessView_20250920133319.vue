                          ...
                          <div class="mb-6 text-center">
                              <div class="relative w-full h-40 bg-gray-100 rounded-lg flex items-center justify-center mb-2">
                                  <div v-if="roomPhotoPreviews.length === 0" class="text-center">
                                      <div class="w-12 h-12 rounded-full bg-blue-100 flex items-center justify-center mx-auto mb-2 cursor-pointer">
                                          <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 text-blue-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                              <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4v16m8-8H4" />
                                          </svg>
                                      </div>
                                      <div class="text-black data-gedung-text font-bold cursor-pointer" @click="triggerRoomPhotoInput">Tambah Foto Ruang</div>
                                  </div>
