      ...
      <div v-if="showFilterModal" class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4" @click="closeFilterModal">
        <div class="bg-blue-100 rounded-lg max-w-lg w-full p-6" @click.stop>
          ...
          <div class="mb-4">
            ...
            <!-- Date Range Inputs -->
            <div class="flex items-center gap-2 bg-white p-3 rounded-lg border border-gray-300" :class="{ 'bg-gray-100': filterAllDates }">
              ...
              <input 
                ...
                type="date"
                class="flex-1 bg-transparent text-black focus:outline-none disabled:text-gray-400 disabled:cursor-not-allowed"
            ...
            <!-- Optional: Custom Calendar Picker Button -->
...
export default {
  ...
  methods: {
    ...
    openCalendarPicker() {
      // Placeholder for custom calendar picker implementation
      // You can integrate with libraries like:
      // - Vue Datepicker
      // - Flatpickr 
      // - Custom calendar component
      alert('Calendar picker akan diimplementasikan dengan library calendar picker seperti Vue Datepicker atau Flatpickr untuk tampilan seperti screenshot yang Anda berikan.');
    },
