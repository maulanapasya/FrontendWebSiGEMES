      ...
      <div class="flex flex-wrap gap-4 mt-6">
        <div class="bg-blue-100 p-6 rounded-xl shadow-lg flex-1">
          <p class="text-gray-800">
            <span v-if="loadingRevenue">
              Pendapatan <span class="skeleton-loader inline-block w-40 h-5 rounded"></span>
            </span>
            <span v-else>Pendapatan {{ currentDayText }}</span>
          </p>
          <h2 class="revenue text-3xl text-black font-bold">
            <div v-if="loadingRevenue" class="skeleton-loader w-48 h-9 rounded mt-1"></div>
        ...
        <div class="bg-blue-100 p-6 rounded-xl shadow-lg flex-1">
          <p class="text-gray-800">
            <span v-if="loadingRevenue">
              Pendapatan bulan <span class="skeleton-loader inline-block w-32 h-5 rounded"></span>
            </span>
        ...
        <div class="bg-blue-100 p-6 rounded-xl shadow-lg flex-1">
          <p class="text-gray-800">
            <span v-if="loadingRevenue">
              Total pendapatan tahun <span class="skeleton-loader inline-block w-16 h-5 rounded"></span>
            </span>
