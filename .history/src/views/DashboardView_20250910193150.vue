// FETCH RENTALS BY BUILDING METHOD 
...
export default {
  ...
  methods: {
    ...
    // New method to create individual building report WITH BETTER ERROR HANDLING
    async createBuildingReport(transactions, buildingName, buildingType, cleanBuildingName, monthName, year) {
      try {
        ...
        // Generate Excel file with additional debugging
