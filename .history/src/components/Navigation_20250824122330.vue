...
.navbar nav {
  ...
  flex-grow: 1; /* Menggunakan ruang yang tersedia untuk menyeimbangkan item */
}
...
.navbar .nav-link {
  ...
  border-bottom: 2px solid transparent;
  transition: border-bottom 0.3s ease-in-out;
  margin: 0 16px; /* Tambahkan margin untuk memberi jarak antar menu */
}
...
/* Responsif untuk admin biasa - hilangkan Daftar Admin */
.navbar nav ul {
  display: flex;
  justify-content: center;
  gap: 32px;
...
/* Centang navbar dan perbaiki posisinya saat opsi Daftar Admin disembunyikan */
