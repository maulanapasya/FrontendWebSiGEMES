<template>
  <header class="navbar flex justify-between items-center px-6 py-3 shadow-md">
    <!-- Logo -->
    <img src="@/assets/sigemesapp.png" alt="Logo Pemda" class="w-20" />
    ...
    <div class="relative">
      <button @click="toggleDropdown" class="bg-white flex text-black items-center px-4 py-2 border rounded-lg shadow-sm focus:outline-none">
        <span class="mr-2 text-black">Superadmin</span>
...
export default {
  ...
  setup() {
    ...
    return { route, router, dropdownOpen, toggleDropdown, logout };
  }
};
</script>
